    ...
    public static function install(Migration $migration): void
    {
        ...
        if (!$DB->tableExists($table)) {
            ...
            $DB->doQuery("CREATE TABLE `$table` (
                ...
                `conf_domain`                        varchar(255) NULL DEFAULT NULL,
                `conf_icon`                          varchar(255) NOT NULL DEFAULT '',
                ...
                `jit_add_profiles`                   tinyint NOT NULL DEFAULT '0',
                `user_sync`                          tinyint NOT NULL DEFAULT '0',
                `sp_certificate`                     text NOT NULL,
                `sp_private_key`                     text NOT NULL,
                `sp_nameid_format`                   varchar(128) NOT NULL DEFAULT '',
                `idp_entity_id`                      varchar(128) NOT NULL DEFAULT '',
                `idp_single_sign_on_service`         varchar(128) NOT NULL DEFAULT '',
                `idp_single_logout_service`          varchar(128) NOT NULL DEFAULT '',
                `idp_certificate`                    text NOT NULL,
                `requested_authn_context`            text NOT NULL,
                `requested_authn_context_comparison` varchar(25) NOT NULL DEFAULT '',
                ...
                `scim_token`                         varchar(255) NULL DEFAULT NULL,
                `comment`                            text NULL,
